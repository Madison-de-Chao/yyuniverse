  ...
  return (
    <div className={`min-h-screen transition-colors duration-1000 ease-in-out ${
      ...
      <div className="fixed top-4 inset-x-0 flex justify-center px-4 z-40 pointer-events-none">
        <div
          className={`decorative-border pointer-events-auto flex flex-col md:flex-row gap-4 items-start md:items-center w-full max-w-5xl px-6 py-4 rounded-2xl border shadow-lg transition-colors duration-500 ${
            theme === 'dark'
